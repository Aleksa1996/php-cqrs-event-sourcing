...
class ArrUtil
{
     ...
     * @return mixed
     */
    public static function firstKey($array, callable $callback = null, $default = null): mixed
    {
        if (is_null($callback)) {
            if (empty($array)) {
                return static::value($default);
    ...
    /**
     * Find the index in the array using the given callback.
     *
     * @param array $array
     * @param callable $callback
     *
     * @return mixed
     */
    public static function findIndex($array, callable $callback): mixed
    {
        return self::firstKey(array_filter($array, $callback, ARRAY_FILTER_USE_BOTH));
    }
    ...
    public static function in(array $array, $key): bool
    {
        ...
        return !empty(ArrUtil::first($array, $callback));
    }
    ...
    public static function unique(array $array, $key, $strict = false): array
    {
        ...
        return ArrUtil::reject($array, function ($item, $key) use ($callback, $strict, &$exists) {
            // @phpstan-ignore-next-line
    ...
    public static function reject(array $array, $callback = true): array
    {
        ...
        return ArrUtil::where($array, function ($value, $key) use ($callback, $useAsCallable) {
     ...
     * @return mixed
     */
    public static function diff($a, $b, $callback): mixed
    {
        return \array_udiff($a, $b, $callback);
    }
}
